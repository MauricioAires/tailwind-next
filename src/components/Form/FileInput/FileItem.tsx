...
const fileItem = tv({
  slots: {
    ...
    icon: 'rounded-full dark:text-zinc-500 dark:border-zinc-700 dark:bg-zinc-800 border-4 border-violet-100 bg-violet-200 p-2 text-violet-600',
    deleteButton: '',
  },
  ...
  variants: {
    state: {
      ...
      error: {
        ...
        deleteButton:
          'text-error-700 hover:text-error-900 dark:text-error-400 dark:hover:text-error-400',
      },
    },
  },
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-error-600 dark:text-error-500/95">
              {name}
            </span>
          </div>
